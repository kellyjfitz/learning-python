...
def exerciseThree():
    #setting out the ticket prices
    classA = 50
    classB = 30
    classC = 15
    ticketPrice = "Your ticket will cost $" #putting this text in a variable to avoid duplication

    ticketClass = input("What class of ticket would you like? A, B or C? ")
    if (ticketClass == "A") or (ticketClass == "a"): #handling upper and lowercase entries
